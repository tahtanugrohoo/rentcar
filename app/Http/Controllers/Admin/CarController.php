...
class CarController extends Controller
{
    ...
    public function store(CarStoreRequest $request)
    {
        ...
        return redirect()->route('admin.cars.index')->with(['message' => 'data berhasil dibuat', 'alert-type' => 'success']);
    ...
    public function destroy(Car $car)
    {
        ...
        return redirect()->back()->with(['message' => 'gambar berhasil dihapus', 'alert-type' => 'danger']);
    }
    ...
    public function updateImage(Request $request, $carId)
    {
        ...
        return redirect()->back()->with(['message' => 'gambar berhasil diedit', 'alert-type' => 'info']);
    }
}
