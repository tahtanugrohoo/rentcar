        ...
        <div class="card-body">
            <form action="{{ route('admin.cars.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="bahan_bakar" class="form-control" value="{{ old('baha_bakar') }}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select name="p3k" id="p3k" class="form-control" value="{{ old('p3k') }}">
                ...
                <div class="form-group">
                    ...
                    <select name="audio" id="audio" class="form-control" value="{{ old('audio') }}">
                        <option value="1">Tersedia</option>
                        <option value="0">Tidak Tersedia</option>
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select name="charger" id="charger" class="form-control" value="{{ old('charger') }}">
                        <option value="1">Tersedia</option>
                        <option value="0">Tidak Tersedia</option>
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select name="ac" id="ac" class="form-control" value="{{ old('ac') }}">
                        <option value="1">Tersedia</option>
                        <option value="0">Tidak Tersedia</option>
                    </select>
                </div>
